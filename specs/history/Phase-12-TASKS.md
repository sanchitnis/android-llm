...
- [ ] Draft Windows Multiplatform architecture design in WINDOWS-ARCHITECTURE.md <!-- id: win_p13 -->
- [ ] Define Windows security sandbox & volatile storage rules in Phase 14 <!-- id: win_p14 -->
- [ ] Define desktop UI/UX & Compose window state lifecycle bounds in Phase 15 <!-- id: win_p15 -->
- [ ] Perform consistency audit & update document indexes across specifications <!-- id: win_p16 -->
