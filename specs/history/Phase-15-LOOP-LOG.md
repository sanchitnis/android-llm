...
| **Phase 12** | Windows Research Lock | 14 | 125,000 | 14,000 | 5,500 | 1 | 1 | 10 lines (approved) | 1.0 (Direct compliance) |
| **Phase 13 (Win)** | Windows App Architecture Draft | 11 | 128,000 | 12,000 | 4,800 | 0 | 0 | 0 lines (approved) | 1.0 (Direct compliance) |
| **Phase 14** | Windows Security & Sandboxing | 12 | 132,000 | 13,000 | 5,200 | 0 | 1 | 8 lines (approved) | 1.0 (Direct compliance) |
| **Phase 15** | Windows UI & Platform UX Design | 11 | 136,000 | 11,500 | 4,600 | 0 | 0 | 0 lines (approved) | 1.0 (Direct compliance) |
...
| **Sprint 7** | Brochure Data Ingestion | 11 | 114,000 | 11,000 | 4,200 | 0 | 1 | 0 lines (approved) | 1.0 (Direct approval) |
| **Sprint 8** | PWA Specification Extension | 15 | 120,000 | 12,500 | 4,800 | 0 | 1 | 0 lines (approved) | 1.0 (Direct approval) |
